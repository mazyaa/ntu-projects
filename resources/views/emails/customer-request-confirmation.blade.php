...
<head>
    ...
    <title>Konfirmasi Permohonan Riksa Uji</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <p style="color: #333; font-size: 15px; margin: 0 0 20px;">
                                Yth. {{ $request->applicant_name }},
                            </p>

                            <p style="color: #333; font-size: 15px; line-height: 1.6; margin: 0 0 30px;">
                                Permohonan Riksa Uji Anda telah kami terima. Berikut adalah detail permohonan Anda:
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid #e5e9f0; border-radius: 6px; overflow: hidden; margin-bottom: 30px;">
                                ...
                                <tr>
                                    <td style="background-color: #f8f9fb; padding: 12px 16px; font-size: 13px; color: #666; border-bottom: 1px solid #e5e9f0;">Tanggal</td>
                                    <td style="padding: 12px 16px; font-size: 14px; color: #333; border-bottom: 1px solid #e5e9f0;">{{ $request->created_at->format('d M Y') }}</td>
                                </tr>
                                <tr>
                                    <td style="background-color: #f8f9fb; padding: 12px 16px; font-size: 13px; color: #666;">Jumlah Objek</td>
                                    <td style="padding: 12px 16px; font-size: 14px; color: #333; font-weight: 600;">{{ $request->objects_count ?? $request->objects->count() }}</td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="{{ url('/dashboard') }}" style="display: inline-block; background-color: #0736AA; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-size: 14px; font-weight: 600;">Lihat Permohonan</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
