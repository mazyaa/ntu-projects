<x-auth-split>
    ...
    <h2 class="text-2xl font-bold text-secondary mb-1">Lupa Password?</h2>
    <p class="text-sm text-gray-500 mb-8">Masukkan alamat email Anda dan kami akan mengirimkan link untuk mereset password Anda.</p>
