...
@section('content')
    <x-landing.page-hero
        :title="'Tentang Kami'"
        :subtitle="'Mengenal lebih dekat PT Nusantara Techno Utama — perusahaan riset dan rekayasa terapan untuk Indonesia yang berkelanjutan.'"
    />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                <div data-aos="fade-right">
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-6">
                        <i data-lucide="book-open" class="w-4 h-4"></i> Cerita Perusahaan
                    </div>
                    <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-6 leading-tight">{{ config('company.name') }}</h2>
                    <div class="space-y-4 text-gray-600 leading-relaxed">
                        <p>{{ config('company.overview.intro') }}</p>
                        <p>{{ config('company.overview.founded') }}</p>
                        <p>{{ config('company.overview.evolution') }}</p>
                    </div>
                </div>
                ...
                <div data-aos="fade-left">
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 text-accent text-sm font-semibold mb-6">
                        <i data-lucide="scroll" class="w-4 h-4"></i> Landasan Hukum
                    </div>
                    <div class="glass-card rounded-3xl overflow-hidden">
                        @foreach(config('company.legal') as $item)
    ...
    <section class="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-6">
                    <i data-lucide="compass" class="w-4 h-4"></i> Visi & Misi
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Arah & Tujuan Organisasi</h2>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="glass-card rounded-3xl p-8 mb-8" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 leading-relaxed text-lg">{{ config('company.vision') }}</p>
                </div>
                ...
                <div class="glass-card rounded-3xl p-8" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ol class="space-y-4">
                        @foreach(config('company.mission') as $index => $mission)
                        <li class="flex gap-4">
    ...
    <section class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 text-accent text-sm font-semibold mb-6">
                    <i data-lucide="lightbulb" class="w-4 h-4"></i> Filsafat Bisnis
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Pendekatan Kami</h2>
                <p class="text-gray-500 max-w-2xl mx-auto">NTU mengintegrasikan tiga pilar pendekatan dalam setiap solusi yang kami hadirkan.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <div class="text-center p-8 glass-card rounded-3xl" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-3">Evidence-Based</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">Setiap rekomendasi dan solusi kami dibangun di atas data empiris, analisis kuantitatif-kualitatif, serta metodologi yang dapat dipertanggungjawabkan secara ilmiah.</p>
                </div>
                ...
                <div class="text-center p-8 glass-card rounded-3xl" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-3">Engineering-Driven</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">Keahlian teknis dan rekayasa menjadi fondasi utama dalam merancang solusi yang aplikatif, efisien, dan sesuai standar nasional maupun internasional.</p>
                </div>
                ...
                <div class="text-center p-8 glass-card rounded-3xl" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h3 class="text-lg font-bold text-secondary mb-3">Sustainability-Focused</h3>
                    <p class="text-sm text-gray-500 leading-relaxed">Keberlanjutan lingkungan, sosial, dan tata kelola (ESG) menjadi prinsip yang menyelimuti setiap aktivitas bisnis dan rekomendasi kebijakan kami.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-6">
                    <i data-lucide="route" class="w-4 h-4"></i> Perjalanan Kami
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Riset & Rekayasa dalam Perjalanan</h2>
            </div>

            <div class="max-w-3xl mx-auto">
                @foreach(config('company.timeline') as $index => $milestone)
                <div class="relative flex gap-8 pb-12 last:pb-0" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                    <div class="shrink-0 flex flex-col items-center">
                        <div class="w-12 h-12 bg-{{ $index === count(config('company.timeline')) - 0 ? 'success' : 'primary' }} rounded-xl flex items-center justify-center text-white shadow-lg">
                            <i data-lucide="{{ $milestone['icon'] }}" class="w-5 h-5"></i>
                        </div>
                        @if($index < count(config('company.timeline')) - 1)
