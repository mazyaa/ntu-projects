    ...
    <section class="py-24 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <a href="{{ route('services.show', $service->slug) }}" class="group glass-card rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-300 flex flex-col" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <p class="text-gray-500 text-sm mb-4 flex-1 leading-relaxed">{{ $service->tagline }}</p>
