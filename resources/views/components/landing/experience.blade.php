    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up">
            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 text-accent text-sm font-semibold mb-6">
                <i data-lucide="building-2" class="w-4 h-4"></i> Pengalaman Kami
            </div>
            <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Rekam Jejak Proyek Strategis</h2>
            <p class="text-gray-500 max-w-2xl mx-auto">NTU telah dipercaya oleh kementerian dan lembaga pemerintah dalam menyelenggarakan kajian kebijakan strategis nasional.</p>
        </div>

        <div class="space-y-6 max-w-4xl mx-auto">
            @foreach(config('company-experience.projects') as $index => $project)
