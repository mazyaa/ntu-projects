<section class="py-24 bg-slate-50" id="articles">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6" data-aos="fade-up">
            <div class="max-w-2xl">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-6">
                    <i data-lucide="newspaper" class="w-4 h-4"></i> Artikel Terbaru
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Wawasan & Informasi K3</h2>
                <p class="text-gray-500">Temukan artikel, panduan, dan berita terbaru seputar keselamatan dan kesehatan kerja di Indonesia.</p>
            </div>
            <a href="#" class="inline-flex items-center text-primary font-bold hover:text-primary/80 transition-colors group">
                Lihat Semua Artikel
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="100">
                <div class="relative h-52 overflow-hidden">
                    ...
                    <div class="absolute bottom-4 left-4 right-4 flex items-center gap-3 text-white/80 text-xs">
                        <span class="flex items-center gap-1"><i data-lucide="clock" class="w-3 h-3"></i> 5 menit baca</span>
                        <span class="flex items-center gap-1"><i data-lucide="calendar" class="w-3 h-3"></i> 12 Mar 2026</span>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-bold text-secondary mb-3 group-hover:text-primary transition-colors leading-snug">Pentingnya Inspeksi Berkala pada Alat Berat di Industri</h3>
                    <p class="text-gray-500 text-sm leading-relaxed mb-4">Inspeksi rutin pada crane dan forklift dapat mencegah kecelakaan kerja serius. Simak panduan lengkap dari para ahli K3 kami.</p>
                    <a href="#" class="text-sm font-bold text-primary flex items-center gap-1 group-hover:gap-2 transition-all">
            ...
            <article class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="200">
                <div class="relative h-52 overflow-hidden">
                    ...
                    <div class="absolute bottom-4 left-4 right-4 flex items-center gap-3 text-white/80 text-xs">
                        <span class="flex items-center gap-1"><i data-lucide="clock" class="w-3 h-3"></i> 7 menit baca</span>
                        <span class="flex items-center gap-1"><i data-lucide="calendar" class="w-3 h-3"></i> 5 Mar 2026</span>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-bold text-secondary mb-3 group-hover:text-primary transition-colors leading-snug">Standar K3 Terbaru Kemnaker RI yang Wajib Dipahami Perusahaan</h3>
                    <p class="text-gray-500 text-sm leading-relaxed mb-4">Pemerintah terus memperbarui regulasi K3. Pelajari perubahan terbaru dan bagaimana perusahaan Anda dapat tetap patuh.</p>
                    <a href="#" class="text-sm font-bold text-primary flex items-center gap-1 group-hover:gap-2 transition-all">
                        Baca Selengkapnya <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </a>
                </div>
            ...
            <article class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-300 group" data-aos="fade-up" data-aos-delay="300">
                <div class="relative h-52 overflow-hidden">
                    ...
                    <div class="absolute bottom-4 left-4 right-4 flex items-center gap-3 text-white/80 text-xs">
                        <span class="flex items-center gap-1"><i data-lucide="clock" class="w-3 h-3"></i> 4 menit baca</span>
                        <span class="flex items-center gap-1"><i data-lucide="calendar" class="w-3 h-3"></i> 22 Feb 2026</span>
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-lg font-bold text-secondary mb-3 group-hover:text-primary transition-colors leading-snug">Proses Sertifikasi Bejana Tekan: Panduan Lengkap untuk Pemilik Industri</h3>
                    <p class="text-gray-500 text-sm leading-relaxed mb-4">Bejana tekan berisiko tinggi memerlukan sertifikasi berkala. Ketahui tahapan dan dokumen yang diperlukan.</p>
                    <a href="#" class="text-sm font-bold text-primary flex items-center gap-1 group-hover:gap-2 transition-all">
                        Baca Selengkapnya <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </a>
                </div>
