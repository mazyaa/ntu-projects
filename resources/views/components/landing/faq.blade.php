<section class="pt-24 pb-40 bg-slate-50 relative overflow-x-clip" id="faq">
    ...
    <div class="max-w-3xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Pertanyaan Umum</h2>
            <p class="text-gray-500 max-w-2xl mx-auto">Temukan jawaban atas pertanyaan yang sering diajukan seputar layanan riset, rekayasa, dan TIC kami.</p>
        </div>

        <div class="space-y-4" x-data="{ active: null }">
            @foreach(config('company-faq') as $index => $faq)
