<footer class="bg-secondary text-white pt-20 pb-10" id="contact">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div class="lg:col-span-1">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://www.instagram.com/{{ company('slug') }}" target="_blank" rel="noopener" aria-label="Instagram" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white hover:scale-110 transition-all duration-300">
                    ...
                    <a href="https://www.facebook.com/{{ company('slug') }}" target="_blank" rel="noopener" aria-label="Facebook" class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white hover:scale-110 transition-all duration-300">
            ...
            <div>
                <h3 class="text-lg font-bold text-white mb-6">{{ __('ui.footer.contact') }}</h3>
                <ul class="space-y-4">
        ...
        <div class="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row justify-center items-center">
            <p class="text-gray-500 text-sm mb-4 md:mb-0">
                &copy; {{ date('Y') }} {{ company('name') }}. {{ __('ui.footer.rights') }}
            </p>
        </div>
    </div>
</footer>
