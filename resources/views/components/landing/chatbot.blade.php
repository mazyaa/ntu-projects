...
<div x-data="chatbot()" class="fixed bottom-6 right-6 z-60 flex flex-col items-end">
    ...
    <a href="https://wa.me/{{ ltrim(company('contact.whatsapp'), '+') }}" target="_blank" rel="noopener" aria-label="Chat via WhatsApp"
       class="fixed bottom-24 right-6 z-60 w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center group">
        <svg viewBox="0 0 24 24" fill="currentColor" class="w-7 h-7 text-white" aria-hidden="true">
