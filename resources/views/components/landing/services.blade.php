<section class="py-24 bg-white relative overflow-hidden cv-auto" id="services">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6" data-aos="fade-up">
            <div class="max-w-2xl">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-semibold mb-6">
                    <i data-lucide="briefcase" class="w-4 h-4"></i> {{ __('ui.services.badge') }}
                </div>
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">{{ __('ui.services.h2') }}</h2>
                <p class="text-gray-500">{{ __('ui.services.subtitle') }}</p>
            </div>
            <a href="{{ lroute('services.index') }}" class="inline-flex items-center text-primary font-bold hover:text-primary/80 transition-colors group">
                {{ __('ui.services.view_all') }}
